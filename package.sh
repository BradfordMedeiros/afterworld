...
(cd ../ModEngine && ./build/modengine --package ../afterworld/build/game.mod --pak ./res --pak ./docs/ --pak ../gameresources/build --pak ../afterworld/scenes/ --pak ../afterworld/design/ --pak ../gameresources/sound/ --pak ../gameresources/video --pak ../gameresources/textures/  --pak ../gameresources/ui/ --pak ../afterworld/shaders/)
