...
void drawCirclePartition(DrawingTools& drawTools, int i, int mappingId, glm::vec4 tint){
  ...
  drawTools.drawLine2D(fromPos, toPos, false, tint, std::nullopt, true, mappingId, std::nullopt);
  drawTools.drawLine2D(glm::vec3(0.f, 0.f, 0.f), fromPos, false, tint, std::nullopt, true, mappingId, std::nullopt);
  drawTools.drawLine2D(glm::vec3(0.f, 0.f, 0.f), toPos, false, tint, std::nullopt, true, mappingId, std::nullopt);
}
