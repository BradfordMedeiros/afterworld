...
Component compassComponent {
  .draw = [](DrawingTools& drawTools, Props& props) -> BoundingBox2D {
    ...
    drawTools.drawRect(rectX, rectY, rectWidth, rectHeight, false, glm::vec4(0.f, 0.f, 1.f, 0.1f), std::nullopt, true, mappingId, std::nullopt, std::nullopt);
    ...
    drawTools.drawLine2D(glm::vec3(0.f, 0.f, 0.f), glm::normalize(glm::vec3(xPos, yPos, 0.f)) * compassNeedleLength, false, glm::vec4(1.f, 0.f, 0.f, 1.f), std::nullopt, true, mappingId, std::nullopt);
