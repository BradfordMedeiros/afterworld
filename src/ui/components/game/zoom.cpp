...
Component zoomComponent {
  .draw = [](DrawingTools& drawTools, Props& props) -> BoundingBox2D {
    ...
    drawTools.drawRect(0, 0, 1.f, 1.f, false, glm::vec4(1.f, 1.f, 1.f, 1.f), std::nullopt, true, std::nullopt, "../gameresources/ui/zoom.png", std::nullopt);
    drawTools.drawText(std::to_string(zoomOptions -> zoomAmount) + "x " + std::string("zoom"), -0.8f, -0.95f, 10.f, false, glm::vec4(1.f, 1.f, 1.f, 1.f), std::nullopt, true, std::nullopt, std::nullopt, std::nullopt);
