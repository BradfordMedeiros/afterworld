...
Component pauseMenuComponent {
  .draw = [](DrawingTools& drawTools, Props& props) -> BoundingBox2D {
    ...
    auto yoffset = floatFromProp(props, yoffsetSymbol, 0.f);
	  ...
	  drawTools.drawRect(0.f, 0.f, 2.f, 2.f, false, glm::vec4(1.f, 1.f, 1.f, 1.f), std::nullopt /* texture id */, true, std::nullopt /* selection id */, "./res/textures/testgradient.png", std::nullopt);
