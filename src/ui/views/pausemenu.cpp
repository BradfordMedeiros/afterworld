...
Component pauseMenuComponent {
  .draw = [](DrawingTools& drawTools, Props& props) -> BoundingBox2D {
    ...
    auto yoffset = floatFromProp(props, yoffsetSymbol, 0.f);
	  ...
	  drawTools.drawRect(0.f, 0.f, 2.f, 2.f, false, glm::vec4(tint.x, tint.y, tint.z, tint.w * interpolateDuration(0.f, 1.f, elapsedTime, 0.2f)), std::nullopt /* texture id */, true, std::nullopt /* selection id */, std::nullopt, std::nullopt, std::nullopt);
